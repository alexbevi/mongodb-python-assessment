...
> * Currently the application sorts by movie title in ascending order - change this to sort by year in descending order
...
>   * Update the main application with a new UI component
>   * Update the application to apply the ratings filter if present
